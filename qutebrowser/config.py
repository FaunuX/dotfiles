...
## Type: QssColor
c.colors.completion.category.bg = '#7aa2f7'
...
## Type: QssColor
c.colors.completion.even.bg = '#16161e'
...
## Type: Dict
try: 
    request.urlopen('https://duckduckgo.com')
except:
...
c.url.searchengines.update({'xkcd': 'https://explainxkcd.com/wiki/index.php/{}'})

## Page(s) to open at the start.
## Type: List of FuzzyUrl, or FuzzyUrl
c.url.start_pages = ['https://wikipedia.org']
...
# config.bind('yy', 'yank')
config.bind('you', 'set-cmd-text -s :open -t youtube.com')
...
c.colors.statusbar.normal.bg = '#16161e'
c.colors.statusbar.normal.fg = '#c0caf5'

c.colors.statusbar.insert.bg = '#7aa2f7'
c.colors.statusbar.insert.fg = '#16161e'

c.colors.statusbar.command.bg = '#1a1b26'
c.colors.statusbar.command.fg = '#c0caf5'

c.colors.statusbar.private.bg = '#ff9e64'
c.colors.statusbar.private.fg = '#16161e'
...
c.colors.tabs.selected.even.fg = '#16161e'
c.colors.tabs.selected.odd.fg = '#16161e'
